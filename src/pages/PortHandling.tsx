...
const PortHandling: React.FC = () => {
  ...
  const serviceCards = [
    { title: "Modjo Dry Port Facility", img: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&q=80&w=400" },
    { title: "Cargo Consolidation", img: "https://images.unsplash.com/photo-1504148455328-c376907d081c?auto=format&fit=crop&q=80&w=400" },
    { title: "CFS Station Management", img: "https://images.unsplash.com/photo-1519003722824-194d4455a60c?auto=format&fit=crop&q=80&w=400" },
    { title: "Yard Security & Tracking", img: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=400" }
  ];
